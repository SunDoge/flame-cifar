...
def cifar_resnet20(pretrained=None, **kwargs):
    ...
    # else:
    #     model = CifarResNet(BasicBlock, [
    #                         3, 3, 3], num_classes=pretrained_settings[pretrained]['num_classes'])
    #     model.load_state_dict(model_zoo.load_url(
    #         pretrained_settings[pretrained]['resnet20']))
    return model
...
def cifar_resnet32(pretrained=None, **kwargs):
    ...
    # else:
    #     model = CifarResNet(BasicBlock, [
    #                         5, 5, 5], num_classes=pretrained_settings[pretrained]['num_classes'])
    #     model.load_state_dict(model_zoo.load_url(
    #         pretrained_settings[pretrained]['resnet32']))
    return model
...
def cifar_resnet44(pretrained=None, **kwargs):
    ...
    # else:
    #     model = CifarResNet(BasicBlock, [
    #                         7, 7, 7], num_classes=pretrained_settings[pretrained]['num_classes'])
    #     model.load_state_dict(model_zoo.load_url(
    #         pretrained_settings[pretrained]['resnet44']))
    return model
...
def cifar_resnet56(pretrained=None, **kwargs):
    ...
    # else:
    #     model = CifarResNet(BasicBlock, [
    #                         9, 9, 9], num_classes=pretrained_settings[pretrained]['num_classes'])
    #     model.load_state_dict(model_zoo.load_url(
    #         pretrained_settings[pretrained]['resnet56']))
    return model


if __name__ == '__main__':
    r20 = cifar_resnet20(num_classes=10)
    print(r20)
